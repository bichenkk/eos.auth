...
import {
  ...
  searchTable,
  editSearch,
} from '../../actions/permissionList'
import { LIST_PAGESIZE } from '../../constants/app'

const { Search } = Input
const pageTitle = 'Manage Data Permission'
const storeKey = 'permissionList'
const createPath = '/permission/create'
const editPath = '/permission/edit'
